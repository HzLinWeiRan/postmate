 ...
 * @type {String}
 */
export var messageType = 'application/x-postmate-v1+json';
/**
 * The maximum number of attempts to send a handshake request to the parent
 * @type {Number}
 */

export var maxHandshakeRequests = 5;
/**
...
export var generateNewMessageId = function generateNewMessageId() {
  return ++_messageId;
};
/**
...
export var resolveOrigin = function resolveOrigin(url) {
...
export var sanitize = function sanitize(message, allowedOrigin) {
  if (typeof allowedOrigin === 'string' && message.origin !== allowedOrigin) return false;
  if (!message.data) return false;
  if (!message.data.postmate) return false;
...
export var resolveValue = function resolveValue(model, property) {
...
_defineProperty(Postmate, "debug", false);

_defineProperty(Postmate, "Promise", function () {
  try {
